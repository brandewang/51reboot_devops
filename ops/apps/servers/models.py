...
class Server(models.Model):
    ...
    sn                  = models.CharField("SN", max_length=120, db_index=True, unique=True, help_text="SN")
    ...
    uuid                = models.CharField("UUID", db_index=True, unique=True, max_length=120, help_text="UUID")
